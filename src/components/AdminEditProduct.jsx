...
const AdminEditProduct = ({ onClose, ProductData, fetchUpdatedData }) => {
  ...
  return (
    <div>
      <div className="bg-white/10 backdrop-blur-sm fixed w-full h-full inset-0 grid place-items-center overflow-y-scroll overflow-x-hidden py-8 z-50">
